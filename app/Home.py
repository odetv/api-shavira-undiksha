...
def title_desc():
    st.set_page_config(page_title="Shavira Undiksha")
    st.sidebar.title("Ganesha Virtual Assistant Undiksha")
    st.sidebar.write("Selamat datang di Virtual Assistant Shavira Undiksha! Kami siap membantu Anda, silahkan bertanya😊")
